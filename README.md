...
- Una pentru testare (H2 in-memory sau separată)
  • Fișiere de configurare separate (application-dev.yml, application-
  test.yml)
  Criterii evaluare:
...
8. Spring Security (10%)
   ...
   Obligatoriu pentru cerințe opționale: Migrarea aplicației monolitice la minimum 3
...
3. Prezentare Finală (obligatoriu)
   ...
   • Lessons learned
   Deadline Etapa Deliverable
   Săptămâna 4
   22 martie
   Planificare Tema proiect. Document specificații +
   diagrame ER
   Săptămâna 10
   Cerințe obligatorii 10 mai
   Model + CRUD + teste basic + Security +
   views + validare
   Săptămâna 14 Finalizare, Cerințe
   opționale
   Microservicii (minim 3 servicii), Documentație
+ deployment
